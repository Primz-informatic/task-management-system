// Buka code disaat ingin test
//const EnhancedTask = require('../models/EnhancedTask');
// Ganti baris require kamu dengan ini:
const TaskModel = (typeof require !== 'undefined') 
    ? require('../models/EnhancedTask') 
...
class TaskRepository {
    ...
    create(taskData) {
        try {
            // PERBAIKAN: Menggunakan TaskModel untuk instansiasi
    ...
    _loadTasksFromStorage() {
        try {
            ...
            tasksData.forEach(taskData => {
                try {
                    // PERBAIKAN: Menggunakan TaskModel untuk akses method static
